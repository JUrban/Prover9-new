...
grep -Eq 'Dense_passive: backing=mmap, directory=[^,]+, records=[0-9]+, record_bytes=[1-9][0-9]*, directory_logical=[0-9]+, directory_allocated=[0-9]+, heap_bytes=[1-9][0-9]*, arena_records=[1-9][0-9]*, arena_record_bytes=[1-9][0-9]*, arena_backing=[1-9][0-9]*, arena_physical=[0-9]+,' \
  "$test_tmp/dense.out"
grep -Eq 'Dense_passive_gc: arena_materialized=[1-9][0-9]*, validation_failures=0, compactions=[0-9]+, records_reclaimed=[0-9]+, arena_bytes_reclaimed=[0-9]+, file_reads=0 \(0 bytes\), file_writes=0 \(0 bytes\),' \
  "$test_tmp/dense.out"
grep -Eq 'Dense_passive: backing=file, directory=[^,]+, records=[0-9]+, record_bytes=[1-9][0-9]*, directory_logical=[0-9]+, directory_allocated=[0-9]+, heap_bytes=[1-9][0-9]*, arena_records=[1-9][0-9]*, arena_record_bytes=[1-9][0-9]*, arena_backing=[1-9][0-9]*, arena_physical=[1-9][0-9]*,' \
  "$test_tmp/file.out"
