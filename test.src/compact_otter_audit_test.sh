...
for run in reference audit compact unit-audit unit-tree-audit unit-compact back-demod-audit back-signature-audit back-tree-audit back-hybrid-audit back-demod-compact; do
