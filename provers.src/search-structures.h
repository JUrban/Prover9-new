...
struct prover_stats {
  unsigned long long  given,
    ...
    dense_passive_selector_file_read_evictions,
    dense_passive_selector_file_read_eviction_bytes,
    dense_passive_selector_file_read_eviction_failures,
    dense_passive_selector_file_min_calls,
    dense_passive_selector_file_buffer_checks,
    dense_passive_selector_file_run_checks,
    ...
    dense_passive_arena_file_cache_eviction_passes,
    dense_passive_arena_file_cache_eviction_bytes,
    dense_passive_arena_file_syncs,
    dense_passive_arena_file_cache_eviction_failures,
    ...
    ancestor_write_buffer_bytes,
    ancestor_file_reads,
    ancestor_file_read_bytes,
    ancestor_file_writes,
    ancestor_file_write_bytes,
    ancestor_file_write_calls,
    ancestor_file_write_call_bytes,
    ancestor_file_cache_eviction_passes,
    ancestor_file_cache_eviction_bytes,
    ancestor_file_syncs,
    ancestor_file_cache_eviction_failures,
    ancestor_offset_lookups,
    ancestor_detached_records,
    ancestor_detached_current,
    ancestor_handle_bytes_avoided,
