...
struct hash_target_inference_stats {
  ...
  unsigned long long requirement_physical;
  unsigned long long requirement_bytes;
  unsigned long long requirement_peak_bytes;
  unsigned long long requirement_compactions;
  unsigned long long requirement_resets;
  unsigned long long requirement_bytes_reclaimed;
  unsigned long long requirement_code_nodes;
  unsigned long long requirement_code_postings;
  unsigned long long requirement_code_queries;
  unsigned long long requirement_code_nodes_examined;
  unsigned long long requirement_code_postings_examined;
  unsigned long long requirement_exact_tests;
  unsigned long long requirement_token_bytes;
