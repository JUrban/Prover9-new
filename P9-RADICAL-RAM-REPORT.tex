...
This is the conservative measured setup: stable-ID packed hints, dense passives,
...
310,153-hint input was run only to 100 givens under 90-CPU-second and
...
\setting{P9-BETTER-PACKED-PLAN.md}, \setting{P9-MEMORY-RESULTS.md}, and
